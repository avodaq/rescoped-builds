...
ToggleIconThemeModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: ToggleIconThemeModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ToggleIconThemeModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.1.1", ngImport: i0, type: ToggleIconThemeModule, declarations: [ToggleIconThemeComponent], imports: [CommonModule, MatSlideToggleModule, ToggleIconModule], exports: [ToggleIconThemeComponent] });
ToggleIconThemeModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: ToggleIconThemeModule, imports: [CommonModule, MatSlideToggleModule, ToggleIconModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: ToggleIconThemeModule, decorators: [{
            type: NgModule,
            args: [{

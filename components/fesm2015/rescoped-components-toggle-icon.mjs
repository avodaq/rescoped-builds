...
ToggleIconModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: ToggleIconModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ToggleIconModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.1.1", ngImport: i0, type: ToggleIconModule, declarations: [ToggleIconComponent], imports: [CommonModule, MatSlideToggleModule], exports: [ToggleIconComponent] });
ToggleIconModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: ToggleIconModule, imports: [CommonModule, MatSlideToggleModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: ToggleIconModule, decorators: [{
            type: NgModule,
            args: [{

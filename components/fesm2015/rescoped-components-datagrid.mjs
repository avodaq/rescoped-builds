...
const setItemPayload = (item, itemPayload = {}) => {
    var _a;
    const _item = item;
    _item._$hiddenItemPayload = Object.assign(Object.assign({}, itemPayloadDefault), Object.assign({}, (_a = _item === null || _item === void 0 ? void 0 : _item._$hiddenItemPayload) !== null && _a !== void 0 ? _a : {}), Object.assign({}, itemPayload));
    return _item;
};
/**
...
const getItemPayloadValue = (item, key) => {
    const _item = item;
    if (!(_item === null || _item === void 0 ? void 0 : _item._$hiddenItemPayload)) {
        console.log(_item);
...
const deleteItemPayload = (item) => {
    item === null || item === void 0 ? true : delete item._$hiddenItemPayload;
    return item;
};
/**
...
const hasItemPayload = (item) => {
    const _item = item;
    return !!(_item === null || _item === void 0 ? void 0 : _item._$hiddenItemPayload);
};
...
class CdkDatagridDataManager {
    ...
    addDataSlotItem(itemPayload, item) {
        ...
        if (!_item) {
            _item = setItemPayload(_item !== null && _item !== void 0 ? _item : (item || {}), itemPayload);
    ...
    setSingleValue(item, key, value, affectedItems) {
        ...
        affectedItems === null || affectedItems === void 0 ? void 0 : affectedItems(getItemPayload(item));
    }
    setGroupValues(key, value, groupId, affectedItems) {
        __classPrivateFieldGet(this, _CdkDatagridDataManager_originalData, "f").forEach(item => {
            ...
            if (itemPayload.groupId === groupId) {
                this.setItemByKeyValue(item, key, value);
                affectedItems === null || affectedItems === void 0 ? void 0 : affectedItems(itemPayload);
            }
        });
    }
    ...
    cloneItemAll(itemPayload = {}) {
        return __classPrivateFieldGet(this, _CdkDatagridDataManager_originalData, "f").map((item, index) => this.cloneItem(item, Object.assign(Object.assign({}, itemPayload), { index })));
    }
    cloneItem(item, itemPayload = {}) {
        var _a, _b;
        const overrides = (_b = (_a = getItemPayload(item)) === null || _a === void 0 ? void 0 : _a.rules) === null || _b === void 0 ? void 0 : _b.overrides;
        const keyMaps = new Map();
        if (typeof overrides === 'object') {
            const overridesKeys = Object.keys(overrides);
            overridesKeys.forEach(key => {
                var _a, _b, _c, _d;
                const action = (_d = (_c = (_b = (_a = getItemPayload(item)) === null || _a === void 0 ? void 0 : _a.rules) === null || _b === void 0 ? void 0 : _b.overrides) === null || _c === void 0 ? void 0 : _c[key]) === null || _d === void 0 ? void 0 : _d.action;
                // action.componentType
                const component = action === null || action === void 0 ? void 0 : action.componentType;
                if (component) {
                    keyMaps.set(key, Object.assign(Object.assign({}, keyMaps.get(key)), { component }));
                    action.componentType = undefined;
                }
                // action.cond
                const cond = action === null || action === void 0 ? void 0 : action.cond;
                if (cond) {
                    keyMaps.set(key, Object.assign(Object.assign({}, keyMaps.get(key)), { cond }));
                    action.cond = undefined;
                }
                // action.transform
                const transform = action === null || action === void 0 ? void 0 : action.transform;
                if (transform) {
                    keyMaps.set(key, Object.assign(Object.assign({}, keyMaps.get(key)), { transform }));
...
class CdkDatagridRuleManager {
    ...
    canValidate(item, key, actionType) {
        var _a;
        return !!((_a = this.canRule(item, key, actionType)) === null || _a === void 0 ? void 0 : _a.validate);
    }
    canRender(item, key, actionType) {
        var _a;
        return !!((_a = this.canRule(item, key, actionType)) === null || _a === void 0 ? void 0 : _a.render);
    }
    canDisable(item, key, actionType) {
        var _a;
        return !!((_a = this.canRule(item, key, actionType)) === null || _a === void 0 ? void 0 : _a.disable);
    }
    canAction(item, key, actionType) {
        var _a;
        return !!((_a = this.canRule(item, key, actionType)) === null || _a === void 0 ? void 0 : _a.action);
    }
    getActionRule(item, key, actionType) {
        var _a;
        const action = (_a = this.getRule(item, key, actionType)) === null || _a === void 0 ? void 0 : _a.action;
        if (!action) {
            return null;
        }
        if (typeof (action === null || action === void 0 ? void 0 : action.cond) === 'function' && action.cond() === true) {
            return action;
        }
        else if (typeof (action === null || action === void 0 ? void 0 : action.cond) === 'boolean' && action.cond === true) {
            return action;
        }
        else if (typeof (action === null || action === void 0 ? void 0 : action.cond) === 'undefined') {
            return action;
        }
        else {
            return null;
    ...
    getRule(item, key, actionType) {
        ...
        const globalOverrideRules = ((_b = (_a = __classPrivateFieldGet(this, _CdkDatagridRuleManager_instances, "m", _CdkDatagridRuleManager_getGlobalRules).call(this, actionType)) === null || _a === void 0 ? void 0 : _a.overrides) === null || _b === void 0 ? void 0 : _b[key]) || {};
        ...
        const itemOverrideRules = ((_d = (_c = __classPrivateFieldGet(this, _CdkDatagridRuleManager_instances, "m", _CdkDatagridRuleManager_getItemRules).call(this, item)) === null || _c === void 0 ? void 0 : _c.overrides) === null || _d === void 0 ? void 0 : _d[key]) || {};
...
_CdkDatagridRuleManager_globalItemRules = new WeakMap(), _CdkDatagridRuleManager_instances = new WeakSet(), _CdkDatagridRuleManager_getItemRules = function _CdkDatagridRuleManager_getItemRules(item) {
    var _a;
    return (_a = getItemPayload(item)) === null || _a === void 0 ? void 0 : _a.rules;
}, _CdkDatagridRuleManager_getGlobalRules = function _CdkDatagridRuleManager_getGlobalRules(actionType) {
    var _a;
    return (_a = __classPrivateFieldGet(this, _CdkDatagridRuleManager_globalItemRules, "f")) === null || _a === void 0 ? void 0 : _a[actionType];
}, _CdkDatagridRuleManager_mergeRules = function _CdkDatagridRuleManager_mergeRules(intoRule, fromRule) {
    var _a, _b, _c, _d, _e;
    return {
        validate: (_a = intoRule.validate) !== null && _a !== void 0 ? _a : fromRule.validate,
        disable: (_b = intoRule.disable) !== null && _b !== void 0 ? _b : fromRule.disable,
        render: (_c = intoRule.render) !== null && _c !== void 0 ? _c : fromRule.render,
        placeholder: (_d = intoRule.placeholder) !== null && _d !== void 0 ? _d : fromRule.placeholder,
        action: (_e = intoRule.action) !== null && _e !== void 0 ? _e : fromRule.action,
    };
}, _CdkDatagridRuleManager_applyRules = function _CdkDatagridRuleManager_applyRules(rules, formControl, initialValue) {
    if ((formControl === null || formControl === void 0 ? void 0 : formControl.value) !== initialValue) {
        (rules === null || rules === void 0 ? void 0 : rules.render) === undefined && (formControl === null || formControl === void 0 ? void 0 : formControl.setValue(initialValue));
        (rules === null || rules === void 0 ? void 0 : rules.render) === true && (formControl === null || formControl === void 0 ? void 0 : formControl.setValue(initialValue));
    }
    if ((rules === null || rules === void 0 ? void 0 : rules.render) === false && (formControl === null || formControl === void 0 ? void 0 : formControl.value) !== '') {
        formControl === null || formControl === void 0 ? void 0 : formControl.setValue('');
    }
    if ((rules === null || rules === void 0 ? void 0 : rules.disable) === true && !(formControl === null || formControl === void 0 ? void 0 : formControl.disabled)) {
        formControl === null || formControl === void 0 ? void 0 : formControl.disable();
    }
    if (!(rules === null || rules === void 0 ? void 0 : rules.disable) && !(formControl === null || formControl === void 0 ? void 0 : formControl.enabled)) {
        formControl === null || formControl === void 0 ? void 0 : formControl.enable();
    }
    if (!(formControl === null || formControl === void 0 ? void 0 : formControl.disabled) && ((rules === null || rules === void 0 ? void 0 : rules.validate) === false || (rules === null || rules === void 0 ? void 0 : rules.validate) === undefined)) {
        formControl === null || formControl === void 0 ? void 0 : formControl.setValidators([]);
        formControl === null || formControl === void 0 ? void 0 : formControl.setAsyncValidators([]);
...
class CdkDatagridEditManager {
    ...
    setActiveEditItem(event) {
        ...
        (_a = this.getEditItem(currentEditAbleItemEl)) === null || _a === void 0 ? void 0 : _a.activeEdit();
    }
    /**
    ...
    setInactiveEditItem(event) {
        ...
        (_a = this.getEditItem(currentEditAbleItemEl)) === null || _a === void 0 ? void 0 : _a.inactiveEdit();
    ...
    setInactiveLastEditItem() {
        var _a;
        (_a = __classPrivateFieldGet(this, _CdkDatagridEditManager_lastEditItemRef, "f")) === null || _a === void 0 ? void 0 : _a.inactiveEdit();
...
_CdkDatagridEditManager_edits = new WeakMap(), _CdkDatagridEditManager_lastEditItemEl = new WeakMap(), _CdkDatagridEditManager_lastEditItemRef = new WeakMap(), _CdkDatagridEditManager_instances = new WeakSet(), _CdkDatagridEditManager_storeLastEditItem = function _CdkDatagridEditManager_storeLastEditItem(element) {
    ...
    const _element = element === null || element === void 0 ? void 0 : element.target;
    if (!_element) {
...
function batchValidatorFactory(validations, field, index) {
    return () => validations.pipe(map(validations => validations === null || validations === void 0 ? void 0 : validations.find(validation => {
...
const mergeValidationErrors = (validationError1, validationError2 = defaultValidationError) => {
    return validationError1 ? Object.assign(Object.assign({}, validationError1), validationError2) : validationError1;
};
class Validators {
...
class CdkDatagridFormManager {
    ...
    addFormControl(formControlName, value, formControlDir, asyncValidatorFn = Validators.nullAsyncValidator()) {
        ...
        __classPrivateFieldGet(this, _CdkDatagridFormManager_formGroup, "f").addControl(formControlName, this._formBuilder.group({
            [formControlName]: this._formBuilder.control(value, {
                validators: [...(((_a = formControlDir.validator) === null || _a === void 0 ? void 0 : _a.validator) || [])],
                asyncValidators: [...(((_b = formControlDir.validator) === null || _b === void 0 ? void 0 : _b.asyncValidator) || []), asyncValidatorFn],
                updateOn: (_d = (_c = formControlDir.validator) === null || _c === void 0 ? void 0 : _c.updateOn) !== null && _d !== void 0 ? _d : 'submit',
            }),
        }));
    ...
    watchBatchValidations(batchValidation$) {
        ...
        return batchValidation$.pipe(tap((validations = []) => {
            ...
            __classPrivateFieldGet(this, _CdkDatagridFormManager_prevValidations, "f").forEach(({ index, field }) => {
                ...
                formControl === null || formControl === void 0 ? void 0 : formControl.setError(null);
            });
            validations.forEach(({ index, field, validationCode, validationMessage }) => {
                const item = this._dataManger.getItemByIndex(index);
                const itemPayload = getItemPayload(item);
                const actionType = itemPayload === null || itemPayload === void 0 ? void 0 : itemPayload.actionType;
                const formControl = __classPrivateFieldGet(this, _CdkDatagridFormManager_formControlsByIds, "f").get(`${index}-${field}`);
                const ruleTypes = this._ruleManager.getRule(item, field, actionType);
                if (ruleTypes.validate && formControl) {
                    formControl === null || formControl === void 0 ? void 0 : formControl.setError({ validationCode, validationMessage });
                }
            });
    ...
    getFormControl(uuid) {
        var _a;
        return (_a = this.getFormControlGroup(uuid)) === null || _a === void 0 ? void 0 : _a.get(uuid);
    }
...
class CdkDatagridStorageDirective {
    ...
    get placeholder() {
        ...
        return (_a = this._ruleManager.getRule(this.item, this.key, action)) === null || _a === void 0 ? void 0 : _a.placeholder;
    }
    get groupId() {
    ...
    setValue(value) {
        ...
        if (action === null || action === void 0 ? void 0 : action.transform) {
...
class CdkDatagridFormControlDirective {
    ...
    get canRender() {
        ...
        return (_a = this._ruleManager.getRule(item, key, actionType)) === null || _a === void 0 ? void 0 : _a.render;
    }
    ...
    get value() {
        var _a;
        return (_a = this.control) === null || _a === void 0 ? void 0 : _a.value;
    }
    get control() {
        var _a;
        return (_a = this._formManager) === null || _a === void 0 ? void 0 : _a.getFormControl(this._storage.createUuid());
    }
    get disabled() {
        var _a;
    ...
    get valid() {
        var _a;
        return (_a = this.control) === null || _a === void 0 ? void 0 : _a.valid;
    }
    get errors() {
        var _a;
        return (_a = this.control) === null || _a === void 0 ? void 0 : _a.errors;
    }
    setError(errors) {
        var _a;
        return (_a = this.control) === null || _a === void 0 ? void 0 : _a.setErrors(errors);
    }
    validate() {
        var _a, _b;
        if (this.valid) {
            (_a = this.control) === null || _a === void 0 ? void 0 : _a.markAsUntouched();
        }
        else {
            (_b = this.control) === null || _b === void 0 ? void 0 : _b.markAsTouched();
        }
    }
    ngOnInit() {
        var _a;
        ...
        const formControl = (_a = this._formManager) === null || _a === void 0 ? void 0 : _a.getFormControl(this.formControlName);
        const initialValue = this.initialValue;
        this._ruleManager.applyRules(item, key, actionType, formControl, initialValue);
        formControl === null || formControl === void 0 ? void 0 : formControl.statusChanges.pipe(tap(() => this._cdr.markForCheck()), takeUntil(__classPrivateFieldGet(this, _CdkDatagridFormControlDirective_unsub$, "f"))).subscribe();
    }
    ngOnDestroy() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: CdkDatagridFormControlDirective, decorators: [{
        ...
        return [{ type: i0.ChangeDetectorRef }, { type: CdkDatagridStorageDirective, decorators: [{
                        type: Inject,
                        args: [DATAGRID_STORAGE_TOKEN]
                    }] }, { type: CdkDatagridFormManager }, { type: CdkDatagridRuleManager }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: CdkDatagridFocusInputDirective, decorators: [{
        ...
        return [{ type: CdkDatagridFormControlDirective, decorators: [{
                        type: Inject,
...
class MatDatagridComboboxComponent {
    ...
    _displayForAutoCompleteOption(option) {
        return option === null || option === void 0 ? void 0 : option[this._storage.renderKey];
    }
    /** @internal */
    get _renderForDefaultView() {
        var _a, _b, _c;
        const value = (_b = (_a = this._formControl) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b[this._storage.renderKey];
        return value ? value : ((_c = this._formControl) === null || _c === void 0 ? void 0 : _c.value) || '';
    }
    /** @internal */
    _filterOptions(search) {
        var _a;
        return (((_a = this.options) === null || _a === void 0 ? void 0 : _a.filter(option => option[this._storage.renderKey]
            .toLowerCase()
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: MatDatagridComboboxComponent, decorators: [{
  ...
  `,
        ...
        return [{ type: CdkDatagridCommonDirective, decorators: [{
                        type: Inject,
...
class MatDatagridInputComponent {
    ...
    ngOnInit() {
        ...
        const componentType = action === null || action === void 0 ? void 0 : action.componentType;
        const componentPosition = action === null || action === void 0 ? void 0 : action.componentPosition;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: MatDatagridInputComponent, decorators: [{
  ...
  `,
        ...
        return [{ type: CdkDatagridCommonDirective, decorators: [{
                        ...
                        type: Inject,
                        args: [DATAGRID_STORAGE_TOKEN]
                    }] }, { type: i0.ChangeDetectorRef }, { type: i0.Injector }, { type: CdkDatagridRuleManager }];
    }, propDecorators: { hostClass: [{
                type: HostBinding,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: CdkDatagridCollapseComponent, decorators: [{
        ...
        return [{ type: undefined, decorators: [{
                        type: Inject,
                        args: [ACTION_DATA]
                    }] }, { type: CdkDatagridDataManager }];
    }, propDecorators: { collapseChange: [{
                type: Output
            }], hostClass: [{
                type: HostBinding,
...
class MatDatagridDatepickerComponent {
    ...
    get _controlValue() {
        var _a;
        return (_a = this._formControl) === null || _a === void 0 ? void 0 : _a.value;
    }
    /** @internal */
    get _dateRender() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: MatDatagridDatepickerComponent, decorators: [{
  ...
  `,
        ...
        return [{ type: CdkDatagridDateAdapter }, { type: CdkDatagridCommonDirective, decorators: [{
                        type: Inject,
                        args: [DATAGRID_COMMON_TOKEN]
                    }] }, { type: CdkDatagridEditDirective, decorators: [{
                        type: Inject,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: MatDatagridEmptyCellComponent, decorators: [{
        ...
        return [{ type: CdkDatagridStorageDirective, decorators: [{
                        type: Inject,
                        args: [DATAGRID_STORAGE_TOKEN]
                    }] }, { type: CdkDatagridRuleManager }, { type: i0.Injector }, { type: i0.ChangeDetectorRef }];
    }, propDecorators: { hostClass: [{
                type: HostBinding,
...
class CdkDatagridModule {
    static forRoot(options) {
        var _a, _b, _c, _d, _e;
        const optionDateFormats = ((_a = options === null || options === void 0 ? void 0 : options.datepicker) === null || _a === void 0 ? void 0 : _a.formats) || {};
        const optionInputFormats = ((_b = options === null || options === void 0 ? void 0 : options.input) === null || _b === void 0 ? void 0 : _b.formats) || {};
        const optionInputNumbers = ((_c = options === null || options === void 0 ? void 0 : options.input) === null || _c === void 0 ? void 0 : _c.numbers) || {};
        ...
        _matDateFormatsDefaults.parse.dateInput = ((_d = optionDateFormats === null || optionDateFormats === void 0 ? void 0 : optionDateFormats.display) === null || _d === void 0 ? void 0 : _d.dateInput) || 'YYYY-MM-DD';
        return {
            ...
            providers: [
                ...
                ...(((_e = options === null || options === void 0 ? void 0 : options.datepicker) === null || _e === void 0 ? void 0 : _e.providers) || []),
            ],
        };
    }
}

...
export declare class CdkDatagridDirective<Item> implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<CdkDatagridDirective<any>, "cdk-table[cdk-datagrid]", ["cdkDatagrid"], { "density": { "alias": "density"; "required": false; }; "rowHover": { "alias": "rowHover"; "required": false; }; "collapsedRows": { "alias": "collapsedRows"; "required": false; }; "cellGap": { "alias": "cellGap"; "required": false; }; "rowGrouping": { "alias": "rowGrouping"; "required": false; }; "groupDesign": { "alias": "groupDesign"; "required": false; }; "dataSource": { "alias": "dataSource"; "required": false; }; "itemRules": { "alias": "itemRules"; "required": false; }; }, { "valueChange": "valueChange"; }, never, never, false, never>;
}

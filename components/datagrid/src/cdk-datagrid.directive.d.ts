...
export declare class CdkDatagridDirective<Item> implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<CdkDatagridDirective<any>, "cdk-table[cdk-datagrid]", ["cdkDatagrid"], { "density": "density"; "rowHover": "rowHover"; "collapsedRows": "collapsedRows"; "cellGap": "cellGap"; "rowGrouping": "rowGrouping"; "groupDesign": "groupDesign"; "dataSource": "dataSource"; "itemRules": "itemRules"; }, { "valueChange": "valueChange"; }, never, never, false, never>;
}

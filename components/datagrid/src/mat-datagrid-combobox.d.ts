...
export declare class MatDatagridComboboxComponent<Item, Options> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatDatagridComboboxComponent<any, any>, "mat-datagrid-combobox", never, { "options": "options"; "selectionAdd": "selectionAdd"; "selectionAddIcon": "selectionAddIcon"; "selectionAddIconColor": "selectionAddIconColor"; "autocomplete": "autocomplete"; }, { "selectionChange": "selectionChange"; "selectionAdded": "selectionAdded"; }, never, never, false, never>;
}

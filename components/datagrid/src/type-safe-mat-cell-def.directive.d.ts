...
export declare class TypeSafeMatCellDefDirective<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<TypeSafeMatCellDefDirective<any>, "[matCellDef],[cdkCellDef]", never, { "matCellDefType": "matCellDefType"; }, {}, never, never, false, never>;
}

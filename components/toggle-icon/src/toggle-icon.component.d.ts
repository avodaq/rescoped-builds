...
export declare class ToggleIconComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ToggleIconComponent, "avo-toggle-icon", never, { "color": "color"; "checkedIcon": "checkedIcon"; "unCheckedIcon": "unCheckedIcon"; "checked": "checked"; }, { "changed": "changed"; }, never, never, false, never>;
}
